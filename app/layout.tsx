...
export const metadata: Metadata = {
  title: 'Physiotherapy Patient Monitoring Software | Pocket Physio',
  description: 'Pocket Physio monitors your patients between appointments via WhatsApp. AI extracts clinical signal from natural conversation — giving physiotherapists real-time intelligence on who\'s progressing, who\'s at risk, and who needs a call today. Built by an NHS physiotherapist.',
  metadataBase: new URL('https://pocketphysio.uk'),
  alternates: {
    canonical: '/',
  },
  authors: [{ name: 'Karam Ibrahim', url: 'https://pocketphysio.uk' }],
  category: 'healthcare technology',
  keywords: [
    'physiotherapy patient monitoring',
    'physiotherapy patient monitoring software',
    'patient monitoring between appointments',
    'WhatsApp patient monitoring physiotherapy',
    'physiotherapy software UK',
    'MSK patient monitoring UK',
    'patient engagement physiotherapy UK',
    'physiotherapy AI software',
    'patient dropout prevention physiotherapy',
    'exercise adherence monitoring UK',
    'private physiotherapy clinic software',
    'sports physiotherapy monitoring software',
    'rehabilitation patient monitoring',
    'physiotherapy clinical intelligence',
  ],
  openGraph: {
    type: 'website',
    url: 'https://pocketphysio.uk',
    title: 'Physiotherapy Patient Monitoring Software | Pocket Physio',
    description: 'AI-powered WhatsApp monitoring that gives physiotherapists real-time intelligence between appointments. Know who\'s progressing, who\'s at risk, and who needs a call — before the next session. Built by an NHS physiotherapist.',
